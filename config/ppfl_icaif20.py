...
# Below code is for the preprocessed data.  We add a feature zero, always
# with value 1, to allow the intercept to be just another weight for
# purposes of vector math.
